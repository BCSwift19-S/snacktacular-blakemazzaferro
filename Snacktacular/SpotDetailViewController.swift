...
class SpotDetailViewController: UIViewController {
    ...
    @IBAction func textFieldEditingChanged(_ sender: UITextField) {
        //setting - editing changed
        saveBarButton.isEnabled = !(nameField.text == "")
    }
    
    @IBAction func textFieldReturnPressed(_ sender: UITextField) {
        //setting - primary action pressed
...
extension SpotDetailViewController: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension SpotDetailViewController: UIImagePickerControllerDelegate {
